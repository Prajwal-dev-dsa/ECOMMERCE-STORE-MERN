...
const SignUpPage = () => {
  ...
  const { signup, loading } = useUserStore(); // destructuring signup and loading from useUserStore
      ...
      >
        <div className="bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full flex cursor-pointer justify-center py-2 px-4 border border-transparent 
